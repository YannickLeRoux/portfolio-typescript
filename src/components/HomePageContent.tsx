...
const HomePageContent = () => {
  return (
    <Container className="mb-5 text-center text-container" style={{ marginTop: '50px' }}>
      ...
      <h2 className="mt-5">
        My name is Yannick Le Roux, <br />
        <strong>Software</strong> and <strong>Web</strong> developer <em>in the making</em>.
      </h2>
      ...
      <p>
        I like to make any kind of applications that could make your life easier or, very humbly, make the world a
        better place.
      </p>
    </Container>
  );
